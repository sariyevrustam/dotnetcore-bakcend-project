...
{
    public class PgResourceTypeRepository : MainPgRepository, IResourceTypeRepository
    {
        public PgResourceTypeRepository(DbSettings _dbSettings, IEventBus _bus) : base(_dbSettings, _bus) { }
