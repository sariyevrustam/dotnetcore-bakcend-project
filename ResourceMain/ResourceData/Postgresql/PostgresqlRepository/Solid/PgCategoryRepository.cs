...
{
    public class PgCategoryRepository : MainPgRepository, ICategoryRepository
    {
        ...
        public ItemResult GetAll()
        {
            ...
            using (NpgsqlConnection connection = this.CreateConnection())
            {
                ...
                {
                    connection.Open();
                    this.CreateFunctionCallQuery(LibraryFunctions.fn_category_get_all, connection);
                    ...
                    using (dataReader)
                    {
                        ...
                        {
                            itemResult.Item = Newtonsoft.Json.JsonConvert.DeserializeObject<List<Category>>((string)dataReader[0]);
                        }
                    }
                    connection.Close();
                }
